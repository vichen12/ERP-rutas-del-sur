...
export default function FlotaPage() {
  ...
  const handleCreate = () => {
    setFormData({ patente: '', modelo: '', km_actual: '', ultimo_cambio_aceite: '', chofer_id: '' })
    setEditingId(null)
    setIsModalOpen(true)
  }
  ...
  const filtered = camiones.filter(c => c.patente.toLowerCase().includes(search.toLowerCase()))
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 space-y-12 relative z-10">
        <header className="flex flex-col xl:flex-row justify-between items-end gap-8">
          ...
          <div className="flex gap-4 w-full xl:w-auto">
            ...
            <button onClick={handleCreate} className="px-8 bg-cyan-600 hover:bg-cyan-500 text-white rounded-3xl font-black uppercase tracking-widest transition-all shadow-lg active:scale-95 flex items-center gap-2">
