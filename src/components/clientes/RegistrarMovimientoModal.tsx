...
export function RegistrarMovimientoModal({ 
  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-start sm:items-center justify-center overflow-y-auto pt-20 sm:pt-4 p-4 bg-[#141c28]/95 backdrop-blur-md animate-in fade-in zoom-in-95 duration-300 font-sans italic" onClick={onClose}>
      <div className="bg-[#141c28] border border-white/10 p-8 lg:p-10 rounded-[3rem] w-full max-w-2xl relative shadow-2xl overflow-y-auto max-h-[90vh] my-auto" onClick={e => e.stopPropagation()}>
