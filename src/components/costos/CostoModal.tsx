...
export function CostoModal({ isOpen, onClose, onSubmit, isSaving, editingData }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-start sm:items-center justify-center overflow-y-auto bg-[#141c28]/90 backdrop-blur-md p-4 font-sans italic" onClick={onClose}>
      <div className="bg-[#141c28] w-full max-w-md rounded-[2.5rem] border border-white/10 p-8 shadow-2xl relative animate-in fade-in zoom-in-95 duration-300 my-auto max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
